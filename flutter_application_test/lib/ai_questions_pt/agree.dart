...
import 'package:flutter_application_test/ai_questions_pt/exercise_level.dart';
import 'package:flutter_application_test/home/home.dart'; // 홈 페이지만 임포트

class ExerciseStartPage extends StatelessWidget {
  const ExerciseStartPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("운동 루틴 시작"),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ExerciseLevelPage(),
                  ),
                );
              },
